...
Ce module est le "moteur" sous le capot de notre plateforme d'audit. Il centralise les flux de travail automatisés.
...
* Parser les sorties brutes (CLI) des outils pour les normaliser en un format **JSON** exploitable par l'interface Flask.
